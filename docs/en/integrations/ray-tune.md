...
| `**train_args`  | `dict, optional` | Additional arguments to pass to the `prepare_train()` method during tuning. These arguments can include settings like the number of training epochs, batch size, and other training-specific configurations.                                                                                           | {}            |
